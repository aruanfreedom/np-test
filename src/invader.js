...
const level = k.addLevel([
    ...
    tiles: {
        '^': () => [k.sprite('invader'), k.area(), k.body(), k.scale(0.7), 'invader'],
        '!': () => [k.sprite('wall'), k.area(), k.body({isStatic: true}), 'left-wall'],
        '&': () => [k.sprite('wall'), k.area(), k.body({isStatic: true}), 'right-wall'],
    }
})
